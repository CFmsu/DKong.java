this project is a recreation of Donkey Kong, made for CSCI 282 (Java programming 2). It has been built solely within java, utilizing JFrame for creating the window and rendering sprites onto that window.
...
I have utilized a series of YouTube tutorials by Kaarin Gaming for platformers to assist in creating the game, as I had no prior experience to creating a game in java: https://www.youtube.com/watch?v=6_N8QZ47toY&list=PL4rzdwizLaxYmltJQRjq18a9gsSyEQQ-0&index=1&ab_channel=KaarinGaming
The tutorial covers the basics of creating a video game in java. It is not a tutorial for Donkey Kong in particular, but just platformers in general, which is the genre of games that donkey kong falls within.
